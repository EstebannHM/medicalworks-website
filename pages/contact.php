...
<head>
    ...
    <title>Contacto - Medical Works</title>
...
<body>
    ...
    <header style="background: #0f172a; padding: 20px; color: white;">
        <h2 style="margin: 0;">Medical Works</h2>
    </header>
    ...
    <div class="contact-container">
        ...
        <div class="cta-section">
            ...
            <div class="cta-buttons">
                ...
                <a href="https://wa.me/50684186031?text=Hola,%20me%20gustaría%20obtener%20más%20información%20sobre%20sus%20productos" 
    ...
    <!-- Footer de referencia-->
    <footer style="background: #0f172a; padding: 24px; color: white; text-align: center; margin-top: 60px;">
        <p style="margin: 0;">&copy; 2024 Medical Works - Todos los derechos reservados</p>
    </footer>

    <!-- Js -->
    <script src="../assets/js/contact.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCnfo4nfE0aSKfZQjPQoUNpg9jyJmNakcw&callback=initMap" async defer></script>
</body>
</html>